...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_historicalscore', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 23, 0, 0))),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='historical_scores', to=orm['game.Team'])),
        ))
    ...
    models = {
        ...
        u'game.game': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
